public class Main {
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + 1.005 + 12; // <--- Edit this line
        System.out.println(textFrom2Primitives);

      textFrom2Primitives += false; // <--- Edit this line
        System.out.println(textFrom2Primitives);

       textFrom2Primitives += 'z'; // <--- Edit this line
        System.out.println(textFrom2Primitives);
